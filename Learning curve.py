...
# 使用斜体标签
axes[0, 0].plot(train_sizes, train_rmse_list, label='Train $\it{RMSE}$ (CV)', marker='o', color='blue')
axes[0, 0].plot(train_sizes, test_rmse_list, label='Test $\it{RMSE}$', marker='o', color='red')
...
axes[0, 1].plot(train_sizes, train_r2_list, label='Train $\it{R²}$', marker='o', color='blue')
axes[0, 1].plot(train_sizes, test_r2_list, label='Test $\it{R²}$', marker='o', color='red')
...
axes[1, 0].plot(train_sizes, train_mae_list, label='Train $\it{MAE}$', marker='o', color='blue')
axes[1, 0].plot(train_sizes, test_mae_list, label='Test $\it{MAE}$', marker='o', color='red')
...
axes[1, 1].plot(train_sizes, train_sep_list, label='Train $\it{SEP}$', marker='o', color='blue')
axes[1, 1].plot(train_sizes, test_sep_list, label='Test $\it{SEP}$', marker='o', color='red')
